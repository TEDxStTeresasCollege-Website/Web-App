                ...
                <div className="row">
                    <div className="col-md-12">
                        ...
                        <p className="text-center text-white text-xl">
                         <br /> By Neha Cherian<br />I BSc Psychology<br /><br />Have you ever rejected an idea thinking it was too “out of the box” and too hard for you<br /> to accomplish? Well, a similar idea occurred to a group of young girls from St. Teresa’s<br /> College, Kochi and despite the blurry path that they’d have to go through, they took the chance.<br />
