    ...
    return (
        <>
            ...
            <div className='bg-night-sky bg-repeat-y bg-black'>
                ...
                <div className="text-white relative flex flex-col items-center justify-center text-center md:w-1/2 mx-auto w-full min-h-screen">
                    <h2 className="text-2xl lg:text-4xl font-semibold text-ted-red serif mb-10">Learn more about TED Circles</h2>
                    <div className="video-container">
                        <iframe className='w-full' src="https://www.youtube-nocookie.com/embed/qvoShsSiHuI?start=1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                </div>

                <div className="flex flex-col gap-5 items-center justify-center font-sans min-h-screen mx-auto w-full md:w-1/2">
                    <h1 className="text-2xl lg:text-4xl mb-5 text-ted-red serif">Camera Roll</h1>
                ...
                <div className="flex flex-col gap-5 items-center text-center justify-center font-sans text-white mx-auto w-5/6 md:w-3/4 min-h-screen">
                    <h2 className="text-2xl lg:text-4xl text-ted-red serif">Our Next Event</h2>
                    <div className="w-96 h-52 bg-gray-800"></div>
                    <h2 className="text-lg">Coming soon!<span></span></h2>
