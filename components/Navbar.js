...
const Navbar = () => {
    ...
    return (
        <>
            <nav className="absolute top-0 flex items-center h-20 w-full z-50 text-sm bg-transparent px-2 md:px-5 lg:px-10">
                ...
                <div className="dropdown float-right">
                    ...
                    <ul className="link-container dropdown-menu hidden mr-2 md:mr-5 lg:mr-10">
                        ...
                        <Link href="/elayne"><a className="navbar-link border border-gray-700 border-t-0">Elayne</a></Link>
