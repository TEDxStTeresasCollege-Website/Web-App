...
INSERT INTO `tedx`.`pre_event_reg` (`f_name`, `l_name`, `addr`, `email`, `ph_no`) VALUES ('Gaurav', 'B', 'Address', 'grbmax@gmail.com', '1234567890');
INSERT INTO `tedx`.`pre_event_reg` (`f_name`, `l_name`, `addr`, `email`, `ph_no`) VALUES ('Sharun', 'R', 'Address', 'email@gmail.com', '6969696969');
INSERT INTO `tedx`.`pre_event_reg` (`f_name`, `l_name`, `addr`, `email`, `ph_no`) VALUES ('Nesrin', 'S', 'Address', 'email@gmail.com', '6969696996');
